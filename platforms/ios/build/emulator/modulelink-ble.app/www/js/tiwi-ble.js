...
.service('$tiwiBle', ['$ble', '$timeout', '$rootScope', '$converter', '$interval', function($ble, $timeout, $rootScope, $c, $interval){
	...
	var devices = {}, scanning = false, currentDevice, SCAN_LIMIT = 10000;
		...
		switch(devices[address].onSubscribe){
			...
			case 5:
				...
				$ble.rssi(function(resp){
						...
						console.log("Phone RSSI FAILED1 :(");
					}, {
						"address": address
					})
				...
				$interval(function(){
					...
					console.log("IN INTERVAL", address);
	...
	var ret = {
		...
		'connect': function(address){
			...
			console.log("PRE-DEVICE", devices[address].disconnected);
